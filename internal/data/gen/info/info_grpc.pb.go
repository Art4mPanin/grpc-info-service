...
const (
	Info_CreateInfo_FullMethodName = "/info.Info/CreateInfo"
)
...
func (c *infoClient) CreateInfo(ctx context.Context, in *CreateInfoRequest, opts ...grpc.CallOption) (*CreateInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateInfoResponse)
	err := c.cc.Invoke(ctx, Info_CreateInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInfoServer) CreateInfo(context.Context, *CreateInfoRequest) (*CreateInfoResponse, error) {
